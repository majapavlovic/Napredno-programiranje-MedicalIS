...
public class UpdateKartonPacijentaTest {
	AbstractSO so;
	...
	public void testPrecondition(String jmbg, String lbo, String ime, String prezime, String god, String mes,
			String dan, String pol, String adresa, String tel, String krvnaGr, String hron, String lekar,
			String errMess) {
		try {
		...
		p.setLekar(l);
		Exception thrown = assertThrows(java.lang.Exception.class, () -> so.precondition(p));
