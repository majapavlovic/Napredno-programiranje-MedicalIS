 ...
 */
package npproj.medicalis_server.controller;
...
import npproj.medicalis_server.so.AbstractSO;
import npproj.medicalis_server.so.AddKartonPacijenta;
import npproj.medicalis_server.so.FindAllUputi;
import npproj.medicalis_server.so.FindKartonPacijenta;
import npproj.medicalis_server.so.FindRezultatAnalize;
import npproj.medicalis_server.so.InsertRezultat;
import npproj.medicalis_server.so.InsertUput;
import npproj.medicalis_server.so.LoginLaborant;
import npproj.medicalis_server.so.LoginLekar;
import npproj.medicalis_server.so.UpdateKartonPacijenta;
import npproj.medicalis_server.threads.ServerThread;
import npproj.medicalis_server.view.FrmMain;
